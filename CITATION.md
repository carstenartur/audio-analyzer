...
If you use **Audio Analyzer**, please cite the archived software release and the repository.

## Preferred citation

Carsten Hammer. **Audio Analyzer**. Version 0.0.4-SNAPSHOT. 2026. Software. GitHub repository: https://github.com/carstenartur/audio-analyzer
