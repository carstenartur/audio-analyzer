...
- REST commands plus ordered SSE are the production collaboration path.
- Browser editing is enabled only after the canonical session projection is loaded and SSE is live.
