...
Issue #274 introduces the first workflow backend that performs real offline audio computation.
It replaces the production simulation adapter without changing the run REST contract introduced by
#273.
