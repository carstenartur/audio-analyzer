...
public interface AudioBlockListener {
   ...
   *
   * <p>Implementations must return promptly and must not perform blocking I/O. A listener that
   * needs slower processing should enqueue the block for its own worker.
   *
